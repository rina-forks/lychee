...
/// Sorts and merges the given iterable of key-valuelist pairs. For keys which
/// occur multiple times, their value lists are concatenated. The returned keys,
/// and the value list for each key, are both sorted by case-insensitive order
